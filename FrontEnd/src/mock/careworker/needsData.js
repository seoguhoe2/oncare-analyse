  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        { code: 'other_disease', label: '기타 질환', type: 'checkbox', choices: ['알레르기', '기타'], hasTextWhen: ['기타'] }
      ]
    },
    {
      code: '3',
    ...
    },
    {
      ...
      title: '자원 이용',
      items: [
        { code: 'hospital_name', label: '진료 병원명(진료과)', type: 'text' },
    ...
    },
    {
      ...
      title: '주관적 욕구',
      items: [
        { code: 'subjective_need', label: '수급자 또는 보호자가 희망하는 개별 욕구', type: 'textarea' }
      ]
    },
    {
      code: '9',
      title: '총평',
      items: [
        { code: 'summary', label: '종합 소견', type: 'textarea' }
      ]
    },
    {
      code: '10',
      ...
      items: [
        ...
        { code: 'wound', label: '상처', type: 'checkbox', choices: ['상처간호', '당뇨발간호', '기타'], hasTextWhen: ['상처간호', '기타'] },
